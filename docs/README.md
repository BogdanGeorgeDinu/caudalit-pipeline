...
| 5 | Transformación: Glue + PySpark | En curso — 31 tests en verde, pendiente de reingestar el 1 de marzo y de la primera ejecución en Glue — [`fase-5-transformacion/`](fase-5-transformacion/) |
