...
| 5 | Transformación: Glue + PySpark | En curso — transformación verificada con 28 tests, pendiente de la primera ejecución en Glue — [`fase-5-transformacion/`](fase-5-transformacion/) |
