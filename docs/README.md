...
| 5 | Transformación: Glue + PySpark | En curso — código y Terraform listos, pendiente de la primera ejecución del job — [`fase-5-transformacion/`](fase-5-transformacion/) |
