...
| 5 | Transformación: Glue + PySpark | En curso — 69 tests en verde, incluidos los dos días de cambio de hora con datos reales, pendiente de reingestar el 1 de marzo y de la primera ejecución en Glue — [`fase-5-transformacion/`](fase-5-transformacion/) |
